...
So this is an insecure deserilization attack and i got more details about it from [HackTricks](https://book.hacktricks.xyz/pentesting-web/deserialization#java-http)

Lets create the payload then xD

Using [PayloadAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Insecure%20Deserialization/Java.md) & [HackTricks](https://book.hacktricks.xyz/pentesting-web/deserialization#java-http) i was able to generate my payload
