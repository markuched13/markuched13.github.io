...
Using [GitHub](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Insecure%20Deserialization/Java.md) & [HackTricks](https://book.hacktricks.xyz/pentesting-web/deserialization#java-http) i was able to generate my payload
